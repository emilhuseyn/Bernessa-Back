...
namespace App.Business.Services.Implementations
{
    public class BrandService : IBrandService
    {
        ...
        public async Task<BrandDTO> GetBrandByIdAsync(int id)
        {
            ...
            if (brand == null)
            {
                throw new Exception("Brend tap?lmad?");
            }
